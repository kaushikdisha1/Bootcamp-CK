...
=>
      ...
      // O/P-> dishaka+   28168  0.0  0.0   9144  2004 pts/1    S+   23:57   0:00 grep --color=auto java

      ps aux | grep java > java_processes.txt

      cat java_processes.txt
      
      // O/P-> dishaka+   28190  0.0  0.0   9144  2088 pts/1    S+   23:58   0:00 grep --color=auto java
...
=>
      ...
      ssh-keygen -t rsa -b 4096 -C "dishakaushik@cloudkeeper.com"     // Generate SSH key pairs
      ...
      mkdir ~/disha                         //created new directory in remote server
...
9. Explore vi/vim for  Creating a text file.
...
=>
      ...
      scp ~/linux_practical/linux_backup.tar.gz akanchha-singh@10.1.210.149:/home/akanchha-singh/disha/           
      
      // O/P-> linux_backup.tar.gz  
